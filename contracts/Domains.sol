...
contract Domains is ERC721URIStorage {
  ...
  string svgPartTwo = '</text></svg>';
    ...
    constructor(string memory _tld) payable ERC721("Mecs Name Service", "MNS") {
        tld = _tld;
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "',
            _name,
            '", "description": "A domain on the Mecs name service", "image": "data:image/svg+xml;base64,',
